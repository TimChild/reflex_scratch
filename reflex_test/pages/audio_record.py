...
#             # id="audio_recorder",
#             on_recording_complete=MyAudioState.update_recorded_audio,
#             # on_audio_chunk=AudioState.stream_transcribe_audio,  # << Ideally would actually use something like this
#         ),
#         rx.cond(
#             MyAudioState.audio_recorded,
#             rx.box(
#                 rx.text(f'Audio: {MyAudioState.audio_recorded}'),
#                 rx.text(f'Transcription: {MyAudioState.transcribed_audio}'),
#                 rx.audio(url=MyAudioState.audio_recorded, controls=True, width="100%")
#             ),
